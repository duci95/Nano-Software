<div id='card'>
    ...
    <div class='products'>
    <?php
        $sql = "SELECT * FROM proizvodi p INNER JOIN proizvodjac pr ON p.ID_proizvodjac=pr.ID_proizvodjac INNER JOIN linkovi l ON p.ID_link=l.ID_link  WHERE lager NOT LIKE 0 AND ID_roditelj_link=3";
